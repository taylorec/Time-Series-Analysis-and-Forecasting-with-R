...
# arithmetic average of the series with its n lags
...
# randomly generate a monthly series with 200 uniform observations 
...
abline(h = 0.05, col="red", lwd=3, lty=2) # define the level of significance"
...
AirPassenger_lamda
AirPassenger_transform <- BoxCox(AirPassengers, lambda = AirPassenger_lamda)
